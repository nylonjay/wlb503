package com.bankscene.bes.welllinkbank.recyclergrid;
...
public class PageRecyclerView extends RecyclerView {
    ...
    private int spanRow = CommDictAction.gridRow; // 行数
    private int spanColumn = CommDictAction.gridColumn; // 每页列数
    ...
    private void update() {
        ...
        if (temp != totalPage) {
            ...
            Trace.e("PageRecyckerView","totlapage=="+totalPage+"CurrentPage=="+currentPage);
        }
    ...
    public class PageAdapter extends Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            holder.itemView.getLayoutParams().width = itemWIth;
            holder.itemView.getLayoutParams().height =itemWIth;
