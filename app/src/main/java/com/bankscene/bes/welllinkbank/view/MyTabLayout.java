...
import com.bankscene.bes.welllinkbank.Util.FragmentChangeManager;
...
public class MyTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorCornerRadius < 0 || mIndicatorCornerRadius > mIndicatorHeight / 2) {
            mIndicatorCornerRadius = mIndicatorHeight / 4;//圆角大小.........................................
        }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    //设置    导航数据
    public void setTabData(List<BaseTabFragment> fragments){
