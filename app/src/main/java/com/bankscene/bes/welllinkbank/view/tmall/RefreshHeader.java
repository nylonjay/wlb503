...
public class RefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout._view_tmall_refresh_header, this, false);
        mTvRemind = (TextView) view.findViewById(R.id.tv_remind);
        ImageView imageView = (ImageView) view.findViewById(R.id.tm_logo);

        Glide.with(getContext()).load(R.drawable.tm_mui_bike).into(imageView);
