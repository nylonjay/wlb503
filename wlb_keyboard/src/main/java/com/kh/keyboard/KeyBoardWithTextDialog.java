...
public class KeyBoardWithTextDialog implements View.OnClickListener {
    protected View view;
    protected Dialog popWindow;
    protected Activity mContext;
    private EditText contentView;
    private List<String> contentList;
    private KhNumberKeyBordView keyboardUtil;
    private boolean auto_close=true;
    private TextView tv_intro;

    public KeyBoardWithTextDialog(final Activity mContext) {
        try {
    ...
    private void initView() {
        try {
            if (keyboardUtil == null)
                keyboardUtil = new KhNumberKeyBordView(mContext, view,popWindow);
