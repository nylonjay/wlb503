...
public class KhNumberKeyBordView {
    ...
    public KhNumberKeyBordView(Activity context, View view,Dialog popupWindow) {
        mContext = context;
        parentView = view;
        mPopuWindow=popupWindow;
        mNumberKeyboard = new Keyboard(mContext, R.xml.keyboard_numbers);
        mLetterKeyboard = new Keyboard(mContext, R.xml.keyboard_numbers);//keyboard_word  410
