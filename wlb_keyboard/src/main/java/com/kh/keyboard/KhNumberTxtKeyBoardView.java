...
public class KhNumberTxtKeyBoardView {
    ...
    public KhNumberTxtKeyBoardView(Activity context, View view,Dialog popupWindow) {
        mContext = context;
        parentView = view;
        mPopuWindow=popupWindow;
        mNumberKeyboard = new Keyboard(mContext, R.xml.keyboard_numbers);
        mLetterKeyboard = new Keyboard(mContext, R.xml.keyboard_word);//keyboard_word  410
